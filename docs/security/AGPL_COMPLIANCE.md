...
If you use this software to provide a service over a network, you MUST:
...
The Sourcing Manager OS is a trustless system. For trust to be verified, the enforcement logic, RLS, Edge Functions, and encryption flow must remain open for audit. Closed forks cannot claim equivalent enforcement without publishing their corresponding source.
...
Add this notice to modified deployments:

```text
This service runs modified AGPLv3 source for The Sourcing Manager OS. Complete corresponding source is available to network users of this service.
```
